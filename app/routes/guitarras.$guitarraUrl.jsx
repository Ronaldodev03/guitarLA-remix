...
export function meta({ data }) {
  ...
  return [
    {
      title: `GuitarLA - ${data[0].nombre}`,
      description: `Guitarras, venta de guitarras, guitarra ${data[0].nombre}`,
    },
  ];
}
...
const Guitarra = () => {
  ...
  return (
    <main className=" contenedor guitarra">
      <img className="imagen" src={imagen} alt={`imagen guitarra ${nombre}`} />
      <div className="contenido">
        ...
        {flagMessage && (
          <div className="message">
            <p>Guitarra añadida al carrito</p>
            <Link to="/carrito">
